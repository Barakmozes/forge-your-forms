...
export default function WaitlistLandingPage({
  ...
  function handleShareTwitter() {
    const text = encodeURIComponent(
      `I just joined the waitlist for ${title}! Join me:`
    );
  ...
  function handleShareWhatsApp() {
    const text = encodeURIComponent(
      `I just joined the waitlist for ${title}! Join me: ${referralLink}`
    );
    window.open(
            ...
            <div className="flex items-center justify-center gap-2 pt-2 animate-in fade-in duration-500 delay-300">
              ...
              >
                ...
                <span>
                  ...
                  {totalSignups === 1 ? "person" : "people"} on the waitlist
                </span>
              </Badge>
            </div>
          )}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                {referralCode && (
                  <p className="text-xs text-center text-muted-foreground pt-1">
                    You were referred by a friend -- you may get priority access.
                  </p>
                )}
              </form>
            ) : (
                ...
                <div className="text-center space-y-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {submitState === "duplicate"
                        ? "We found your existing signup. Here are your details."
                        : "Thanks for joining the waitlist. We will notify you when it is your turn."}
                    </p>
                  </div>
                </div>
